...
image : if present, will be used as image in a script button. Must be a .png 24 file.
  ...
  The following keywords can be used other than 'image': small, listItem. By default, their values will reference a file path.
...
function getFolderScriptObjs(folderPath){
  ...
  var jsxFiles = Folder(folderPath).getFiles("*.jsx");
...
function setUpAllFolderScriptButtons(parent){
  ...
  var currentGroupFolder, folderScriptName, currentFolderScript, lbl_group;
